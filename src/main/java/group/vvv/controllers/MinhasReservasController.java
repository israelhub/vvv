...
public class MinhasReservasController {
    ...
    private void addTicketContent(Document document, Ticket ticket, 
        ...
        addTableRow(table, "Origem:", ticket.getReserva().getViagem().getOrigemLocal().getLocal().getDescricaoCompleta(), headerFont, normalFont);
        addTableRow(table, "Destino:", ticket.getReserva().getViagem().getDestinoLocal().getLocal().getDescricaoCompleta(), headerFont, normalFont);
        
        DateTimeFormatter dateFormatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
        DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern("HH:mm");
        
        addTableRow(table, "Data Partida:", 
            ticket.getDataPartida().toLocalDate().format(dateFormatter),
